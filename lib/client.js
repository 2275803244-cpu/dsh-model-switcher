...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ModelSwitcherAction({ available, loadDirectory, selectModel, subscribe, getSnapshot }) {
			...
			const activeId = groups.some((g) => g.id === activeProvider)
				? activeProvider
			...
			return jsxs("div", {
				...
				children: [
					...
					open ? jsx("div", { className: styles.panel, style: panelPos, children: [
						...
						groups.length > 0 ? jsxs("div", { className: styles.groupBody, children: [
							jsx("div", { className: styles.chips, children: groups.map((group) => {
